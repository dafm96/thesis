...
\title[Exploratory Analysis of Individual Metrics in Team Sports Using \emph{IoT} Sensors]{Exploratory Analysis of Individual Metrics in Team Sports Using Inertial Sensors}
\subtitle{}

% Autor
% use [f] for female and [m] for male
\authorname[m]{David António Freire Moura}{David Moura}
\authordegree{Bachelor in Computer Science and Engineering}
...
% use [f] for female and [m] for male
\adviser[f]{Carmen Pires Morgado}{Assistant Professor}{\\& Faculdade de Ciências e Tecnologia da \\&Universidade Nova de Lisboa} 
...
% use [f] for female and [m] for male
\coadviser[m]{Ruben Duarte Dias da Costa}{Director}{\\&Knowledgebiz Consulting}
...
\committee[c,m]{Doutor Fernando Pedro Reino da Silva Birra, Prof. Auxiliar, Faculdade de Ciências e
Tecnologia da UNL - Dep. de Informática}
% % Main raporteurs
\committee[r,f]{Doutor Carlos Jorge de Sousa Gonçalves, Professor Ajunto, ISEL - Dep. Eng. Electrónica e
Telecomunicações e de Computadores}
% \committee[r,f]{Name of another raporteur}
% % Advisers
\committee[a,f]{Doutora Carmen Pires Morgado, Prof. Auxiliar, Faculdade de Ciências e Tecnologia da UNL -
Dep. de Informática}
...
\chapterfile{elaboration1}
\chapterfile{elaboration2}
\chapterfile{elaboration3}
\chapterfile{elaboration4}
\chapterfile{elaboration5}
\chapterfile{elaboration6}
...
\addbibresource{mendeleyBib.bib}
