...
\subsection{Dribbles}
To test the dribble detection algorithm algorithm described in Subsection~\ref{subsec:dribbles}, it was asked to 5 subjects to perform a set of 20 dribbles, at three different speeds: slow ($\approx$90 dribbles per minute), medium ($\approx$120 dribbles per minute) and fast ($\approx$160 dribbles per minute). The dribbles were all performed in-place.
