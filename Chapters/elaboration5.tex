...
Figures \ref{fig:direitoStill} and \ref{fig:esquerdoStill} show the plot of the 3 distances, with data collected from the right and the left foot, respectively.
...
The first test was to walk in a straight line and doing 90$^{\circ}$ right turns, in the office corridors. The route is illustrated in Figure~\ref{fig:caracol}.
\begin{figure}
    \centering
