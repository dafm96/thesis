...
Regarding the metrics identification algorithms, the algorithms with the worst results, like the jumps, or the position tracking while running, should be improved. While the position tracking worked well when walking, the identification when running should be improved. Fot the jumping detection algorithm, besides the improvement of the algorithm, more sensors could be used, to gather more data about the movements of the player, and to help the algorithm detecting what movements are jumps.
