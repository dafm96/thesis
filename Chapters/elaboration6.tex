...
There are some trade-offs that where made due to the factor of keeping the costs low, such as the use of low quality \gls{IMU} sensors, which deteriorates the quality of the data. However, the results obtained with this study showed that some insightful metrics can be extracted, even with poor data.
