...
Regarding the metrics identification algorithms, more advanced classification techniques could be used, like machine learning methods, as seen in the related works, in Section~\ref{sec:relatedWork}. However, this would mean that a large amount of data should be collected to provide to the machine learning classification methods.
