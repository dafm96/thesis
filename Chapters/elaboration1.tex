...
The proposed objective of this dissertation is to develop a system that is capable of tracking basketball players, by collecting data from them and calculating game metrics, like shoots and passes, in order to provide insights about player and team performance in real-time. However, the methodologies applied in this work could be applied to track players of other sports, by changing the metric algorithms and the places from where the data is collected.
...
\begin{enumerate}
    ...
    \item Implementation of a body sensor using a wireless communication protocol to transmit data, and an analysis of the quality and avaiability of the data collected from the sensors
