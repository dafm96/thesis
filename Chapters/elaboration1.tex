...
\epigraph{
    ...
    This dissertation was developed within a corporate context, with the support of KnowledgeBiz Consulting (\gls{KBZ})~\cite{kbz}.
}
...
Several sports are often practiced indoors, which prevents the use of \gls{GPS} positioning. In this cases, a tracking system using inertial sensors like accelerometers or gyroscopes can be used. In order to test this tracking system, basketball was the sport chosen.
...
\begin{enumerate}
    ...
    \item Development of an system that collects data from inertial sensors, analyses it and displays the insights for the players and the team
