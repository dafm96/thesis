...
During the development of this work, two companies were contacted. Although we do not have a scenario for it to be possible to calculate a budget, the responses where that the cost could range between tens to hundreds of thousands of euros, by the time of writing of this dissertation.