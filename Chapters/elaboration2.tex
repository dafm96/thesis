...
%REFERENCE https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4501835/
J.Sampaio~\textit{et al.} analyze the game performance of \gls{NBA} players, from open-access \gls{NBA} data, and grouped some variables, to obtain information about game actions, like pull-up shots, catch and shoots, close shots, drives, passing-variables (like scores from passes, or assists), touches-variables (like touches per game or time of possession), speed and distance, rebounds and free-throw percentage.
...
%TODO falar dos sistemas de video tracking quando falo de sistemas de deteção de movimento
...
By analysing different \gls{IoT} computing architectures, it was also found that this kind of system could benefit from using an edge-processing style architecture, because it can improve the need to process data in real-time, allowing for low latency in the analysis of data.
