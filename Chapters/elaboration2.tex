...
%TODO Low perfomance: mas mesmo assim podem ser utilizados?
...
%TODO unreliable: há algum que seja fiável?
...
%TODO high processing power: 
%Em termos de computação?
%E em termos de qualidade das câmaras de vídeo? existem requisitos?
...
%TODO Como se chega a este valor? (HZ)
% Como se medem estes custos?
% No fim quais foram os sensores utilizados?
% Como é que se consegue replicar este trabalho? (GIT)
...
%TODO the cloud is also capable:
%Implicações da latência da rede no tipo de aplicações que esta tese esta a tratar?
%Influência das interferências eletromagnéticas nas comunicações?
...
%TODO these factors
% Em conclusão pode-se dizer que obter estas métricas em tempo real não é uma boa opção?
% Será que se justifica a utilização de abordagens mistas?
% Qual/quais seriam as implicações neste trabalho?
