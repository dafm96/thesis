...
%TODO porque é q a arquitetura foi pensada assim
%TODO justificar a escalabilidade
%TODO inicialmente pensou-se em processamento no terminal (telemovel), mas porque é que se deve passar para a edge
%TODO descrever mais cada um dos módulos
%TODO server métricas já calculadas, que possa ter por cima uma camada analitica
%TODO interface para ambientes moveis que permite consultar dados armazenados, e ter por cima uma camada analitica
%TODO diferente informações para treinadores ou público
...
%TODO Explicar problematica e justificar arquitetura
...
It also should provide real-time data of individual game metrics, calculated with the raw data from the \gls{IMU} Sensors.
...
The proposed architecture is shown in Figure~\ref{fig:architectureProposal}, and it is comprised of three segments: \textbf{Edge} - Data Collection and Processing; \textbf{Server} - Data Storing and Application Server; \textbf{Client} - Frontend Application.
