...
It also should provide real-time data of individual game metrics, calculated with the raw data from Wearable Sensors. This raw data should only serve to calculate more advanced performance metrics, and should be discarded after being used, so it doesn't waste storage space.
...
The user, whether he is a coach, a player or a fac, should be able to view the processed data and statistics from players, teams and games, in a mobile application.
