...
A game of basketball is played by two teams of 5 players, and 8 players at the most can be on the bench, to substitute the ones currently playing. If every player uses 3 devices, this could mean data collection from up to 30 devices to track every player in court during a basketball game.
