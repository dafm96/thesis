...
%TODO Este tipo de dados são mais ou menos estáticos e quase não mudam.
%Onde se faz a gestão deste tipo de dados? No servidor?
...
%TODO IMU de que tipo? relação com estado da arte?
%TODO EPU Distribuição por utilizador ou por tipo de sensor?
\begin{figure}
    \centering
...
\begin{itemize}
    \item State control %TODO estas operações são realizadas em modo manual?
          \begin{itemize}
...
%TODO for example para a frente
%Não falta nada nesta frase?
%A propagação das mensagens do servidor para os vários EPU não está clara.
%Consegue explicar melhor? Exitem vários EPU e vários IMU mas não se percebe como está feita a distribuição dos IMU pelos EPU
