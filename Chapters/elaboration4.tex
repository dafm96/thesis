...
\section{Data}
\label{sec:data}
%O que estamosa  medir
%como estamos a medir
%exemplificar (com gráficos?)
%falar da precisão e da mudança de ranges (g)
