...
As the number of sensors can grow, and due to the limitation of the number of connections to a Bluetooth receiver~\cite{TexasInstruments},
...
The implementation of the client application was developed with a focus on the coach perspective. Some of the API features described in \ref{susubsec:API} weren't implemented in the client application, like the ability to edit teams and players.
