...
%TODO talk about the graphs

\begin{figure}[htbp]
    \centering
    \subcaptionbox{Accelerometer Raw Data\label{fig:accExample}}%
    {\includegraphics[width=0.7\linewidth]{XYZ_Acceleration_example.pdf}}%
    \\
    \subcaptionbox{Gyroscope Raw Data\label{fig:gyrExample}}%
    {\includegraphics[width=0.7\linewidth]{XYZ_Gyroscope_example}}%
    \\
    \subcaptionbox{Magnetometer Raw Data\label{fig:magExample}}%
    {\includegraphics[width=0.7\linewidth]{XYZ_Magnetometer_example}}%
