...
The architecture should be composed of two segments: player team segment, where each player wears one or more device, and a central device (an Android device, a Rasperry Pi or a computer) that connect and collects the data from all the devices, analyses it and displays the processed data in real-time.
